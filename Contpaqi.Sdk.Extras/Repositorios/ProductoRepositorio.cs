...
namespace Contpaqi.Sdk.Extras.Repositorios
{
    public class ProductoRepositorio
    {
        ...
        private readonly UnidadMedidaRepositorio _unidadMedidaRepositorio;
        private readonly ValorClasificacionRepositorio _valorClasificacionRepositorio;

        public ProductoRepositorio(IContpaqiSdk sdk)
        {
            _sdk = sdk;
            _unidadMedidaRepositorio = new UnidadMedidaRepositorio(sdk);
