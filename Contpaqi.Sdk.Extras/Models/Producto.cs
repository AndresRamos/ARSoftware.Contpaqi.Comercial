...
namespace ARSoftware.Contpaqi.Comercial.Sdk.Extras.Models
{
    public class Producto : admProductos
    {
        ...
        public UnidadMedida UnidadBase { get; set; } = new UnidadMedida();
        public UnidadMedida UnidadNoConvertible { get; set; } = new UnidadMedida();
        public ValorClasificacion ValorClasificacion1 { get; set; } = new ValorClasificacion();
        public ValorClasificacion ValorClasificacion2 { get; set; } = new ValorClasificacion();
        public ValorClasificacion ValorClasificacion3 { get; set; } = new ValorClasificacion();
        public ValorClasificacion ValorClasificacion4 { get; set; } = new ValorClasificacion();
        public ValorClasificacion ValorClasificacion5 { get; set; } = new ValorClasificacion();
        public ValorClasificacion ValorClasificacion6 { get; set; } = new ValorClasificacion();
