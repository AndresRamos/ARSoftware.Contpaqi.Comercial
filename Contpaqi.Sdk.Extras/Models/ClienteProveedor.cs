...
namespace ARSoftware.Contpaqi.Comercial.Sdk.Extras.Models
{
    public class ClienteProveedor : admClientes
    {
        ...
        public Agente AgenteCobro { get; set; } = new Agente();
        public Agente AgenteVenta { get; set; } = new Agente();
        ...
        public ValorClasificacion ValorClasificacionCliente1 { get; set; } = new ValorClasificacion();
        public ValorClasificacion ValorClasificacionCliente2 { get; set; } = new ValorClasificacion();
        public ValorClasificacion ValorClasificacionCliente3 { get; set; } = new ValorClasificacion();
        public ValorClasificacion ValorClasificacionCliente4 { get; set; } = new ValorClasificacion();
        public ValorClasificacion ValorClasificacionCliente5 { get; set; } = new ValorClasificacion();
        public ValorClasificacion ValorClasificacionCliente6 { get; set; } = new ValorClasificacion();
        public ValorClasificacion ValorClasificacionProveedor1 { get; set; } = new ValorClasificacion();
        public ValorClasificacion ValorClasificacionProveedor2 { get; set; } = new ValorClasificacion();
        public ValorClasificacion ValorClasificacionProveedor3 { get; set; } = new ValorClasificacion();
        public ValorClasificacion ValorClasificacionProveedor4 { get; set; } = new ValorClasificacion();
        public ValorClasificacion ValorClasificacionProveedor5 { get; set; } = new ValorClasificacion();
        public ValorClasificacion ValorClasificacionProveedor6 { get; set; } = new ValorClasificacion();
        ...
        public tCteProv ToTCteProv()
        {
            return new tCteProv
            {
                ...
                cCodigoValorClasificacionCliente1 =
                    ValorClasificacionCliente1.CIDCLASIFICACION != 0
                        ? ValorClasificacionCliente1.CCODIGOVALORCLASIFICACION
                        : string.Empty,
                cCodigoValorClasificacionCliente2 =
                    ValorClasificacionCliente2.CIDCLASIFICACION != 0
                        ? ValorClasificacionCliente2.CCODIGOVALORCLASIFICACION
                        : string.Empty,
                cCodigoValorClasificacionCliente3 =
                    ValorClasificacionCliente3.CIDCLASIFICACION != 0
                        ? ValorClasificacionCliente3.CCODIGOVALORCLASIFICACION
                        : string.Empty,
                cCodigoValorClasificacionCliente4 =
                    ValorClasificacionCliente4.CIDCLASIFICACION != 0
                        ? ValorClasificacionCliente4.CCODIGOVALORCLASIFICACION
                        : string.Empty,
                cCodigoValorClasificacionCliente5 =
                    ValorClasificacionCliente5.CIDCLASIFICACION != 0
                        ? ValorClasificacionCliente5.CCODIGOVALORCLASIFICACION
                        : string.Empty,
                cCodigoValorClasificacionCliente6 =
                    ValorClasificacionCliente6.CIDCLASIFICACION != 0
                        ? ValorClasificacionCliente6.CCODIGOVALORCLASIFICACION
                        : string.Empty,
