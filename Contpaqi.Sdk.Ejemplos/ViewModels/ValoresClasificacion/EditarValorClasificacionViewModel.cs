...
namespace Contpaqi.Sdk.Ejemplos.ViewModels.ValoresClasificacion
{
    public class EditarValorClasificacionViewModel : ObservableRecipient
    {
        ...
        public EditarValorClasificacionViewModel(IValorClasificacionService valorClasificacionService, IClasificacionRepository<Clasificacion> clasificacionRepository, IDialogCoordinator dialogCoordinator, IValorClasificacionRepository<ValorClasificacion> valorClasificacionRepository)
        {
        ...
        {
            var valor = _valorClasificacionRepository.BuscarPorId(valorClasificacionId);
            ValorClasificacionId = valor.Id;
            Codigo = valor.Codigo;
            Valor = valor.Valor;

            var clasificacion = _clasificacionRepository.BuscarPorId(valor.IdClasificacion);
            ClasificacionId = clasificacion.Id;
            ClasificacionNumero = ClasificacionHelper.BuscarNumeroPorId(clasificacion.Id);
