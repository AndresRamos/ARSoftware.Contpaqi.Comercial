...
namespace Contpaqi.Sdk.Ejemplos.ViewModels.ValoresClasificacion
{
    public class CrearValorClasificacionViewModel : ObservableRecipient
    {
        ...
        {
            var clasificacion = _clasificacionRepository.BuscarPorId(clasificacionId);
        ...
        public async Task CrearAsync()
        {
            try
            {
                var valorClasificacion = new tValorClasificacion {cNumClasificacion = ClasificacionId + 1, cCodigoValorClasificacion = Codigo, cValorClasificacion = Valor}; // Al parece se necesita agregar +1 al id para que cree el valor en la clasificacion correcta.
