...
namespace ARSoftware.Contpaqi.Comercial.Sdk.Extras.Models.Enums
{
    public class MetodoPago
    {
        ...
        /// </summary>
        public static readonly MetodoPago PUE = new MetodoPago("PUE", "Pago en una sola exhibición");

        /// <summary>
        ///     PPD - Pago en parcialidades o diferido
        /// </summary>
        public static readonly MetodoPago PPD = new MetodoPago("PPD", "Pago en parcialidades o diferido");
