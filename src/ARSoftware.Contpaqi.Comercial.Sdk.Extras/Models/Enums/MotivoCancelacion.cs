...
public sealed class MotivoCancelacion
{
    ...
    /// </summary>
    public static readonly MotivoCancelacion _01 = new("01", "Comprobantes emitidos con errores con relación.");

    /// <summary>
    ///     02 - Comprobantes emitidos con errores sin relación.
    /// </summary>
    public static readonly MotivoCancelacion _02 = new("02", "Comprobantes emitidos con errores sin relación.");

    /// <summary>
    ///     03 - No se llevó a cabo la operación.
    /// </summary>
    public static readonly MotivoCancelacion _03 = new("03", "No se llevó a cabo la operación.");

    /// <summary>
    ///     04 - Operación nominativa relacionada en una factura global.
    /// </summary>
    public static readonly MotivoCancelacion _04 = new("04", "Operación nominativa relacionada en una factura global.");
