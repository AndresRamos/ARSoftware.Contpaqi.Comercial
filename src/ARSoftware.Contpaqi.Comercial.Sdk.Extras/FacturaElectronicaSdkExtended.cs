...
public class FacturaElectronicaSdkExtended : IContpaqiSdk
{
    ...
    {
        return AdminpaqSdk.fRegresaExistenciaCaracteristicas(aCodigoProducto, aCodigoAlmacen, aAnio, aMes, aDia, abreviaturaValorCaracteristica1,
    ...
    public int InicializarSDK()
    {
        ...
        if (result == SdkConstantes.CodigoExito) result = fInicializaLicenseInfo(LicenseInfoSdk.FacturaElectronica);
    ...
    public string NombreLlaveRegistro => FacturaElectronicaSdkConstants.NombreLlaveRegistro;

    public string NombrePaq => FacturaElectronicaSdkConstants.NombrePaq;
