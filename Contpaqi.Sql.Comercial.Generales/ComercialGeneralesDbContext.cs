...
namespace Contpaqi.Sql.Comercial.Generales
{
    ...
    {
        static ComercialGeneralesDbContext()
        {
            Database.SetInitializer(new NullDatabaseInitializer<ComercialGeneralesDbContext>());
        }

        public ComercialGeneralesDbContext()
            : base("name=ComercialGeneralesDbContext")
        {
        }
