using Contpaqi.SistemasComerciales.Sql.Empresas.Modelo;
using System.Data.Common;
using System.Data.Entity;

namespace Contpaqi.SistemasComerciales.Sql.Empresas.AccesoADatos
{
    public partial class ComercialEmpresasContext : DbContext
    {
        static ComercialEmpresasContext()
        {
            Database.SetInitializer(new NullDatabaseInitializer<ComercialEmpresasContext>());
        }

        public ComercialEmpresasContext()
            : base("name=ComercialEmpresasContext")
        {
        }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<admCertificadosProveeedor>()
                .Property(e => e.CRFC)
                .IsUnicode(false);

            modelBuilder.Entity<admCertificadosProveeedor>()
                .Property(e => e.CNOSERIE)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<admDocumentosXMLTemp>()
                .Property(e => e.CTIPO)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<admDocumentosXMLTemp>()
                .Property(e => e.CDESCERROR)
                .IsUnicode(false);

            modelBuilder.Entity<admDocumentosXMLTemp>()
                .Property(e => e.CRAZONRECE)
                .IsUnicode(false);

            modelBuilder.Entity<admDocumentosXMLTemp>()
                .Property(e => e.CRFCRECE)
                .IsUnicode(false);

            modelBuilder.Entity<admDocumentosXMLTemp>()
                .Property(e => e.CNOSERCERT)
                .IsUnicode(false);
