...
namespace Contpaqi.SistemasComerciales.Sdk.Extras.Interfaces
{
    public interface ISistemasComercialesSdk
    {
        ...
        int fAltaDocumentoCargoAbono(tDocumento aDocumento);
        int fAltaDocumentoCargoAbonoExtras(tDocumento aDocumento, string aTextoExtra1, string aTextoExtra2, string aTextoExtra3, string aFechaExtra, double aImporteExtra1, double aImporteExtra2, double aImporteExtra3, double aImporteExtra4);
