...
namespace Contpaqi.Sql.Nominas.Generales
{
    ...
    public partial class NominasGeneralesDbContext : DbContext
    {
        ...
        public NominasGeneralesDbContext(string nameOrConnectionString) : base(nameOrConnectionString)
        {
        }

        public NominasGeneralesDbContext(string nameOrConnectionString, DbCompiledModel model) : base(nameOrConnectionString, model)
        {
        }

        public NominasGeneralesDbContext(DbConnection existingConnection, bool contextOwnsConnection) : base(existingConnection, contextOwnsConnection)
        {
        }

        public NominasGeneralesDbContext(DbConnection existingConnection, DbCompiledModel model, bool contextOwnsConnection) : base(existingConnection, model, contextOwnsConnection)
        {
        }

        public NominasGeneralesDbContext(ObjectContext objectContext, bool dbContextOwnsObjectContext) : base(objectContext, dbContextOwnsObjectContext)
        {
        }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DiccionarioCatalogos>()
            ...
            modelBuilder.Entity<DiccionarioCatalogos>()
                .Property(e => e.CampoBD)
                .IsUnicode(false);

            modelBuilder.Entity<DiccionarioCatalogos>()
                .Property(e => e.CampoImportacion)
                .IsUnicode(false);

            modelBuilder.Entity<DiccionarioDescripciones>()
                .Property(e => e.Descripcion)
                .IsUnicode(false);
