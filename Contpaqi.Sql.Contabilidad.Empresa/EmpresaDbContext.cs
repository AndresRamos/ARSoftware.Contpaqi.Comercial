...
namespace Contpaqi.Sql.Contabilidad.Empresa
{
    ...
    {
        static EmpresaDbContext()
        {
            Database.SetInitializer(new NullDatabaseInitializer<EmpresaDbContext>());
        }

        public EmpresaDbContext()
            : base("name=EmpresaDbContext")
        {
        }

        public EmpresaDbContext(string nameOrConnectionString) : base(nameOrConnectionString)
        {
        }

        public EmpresaDbContext(string nameOrConnectionString, DbCompiledModel model) : base(nameOrConnectionString, model)
        {
        }

        public EmpresaDbContext(DbConnection existingConnection, bool contextOwnsConnection) : base(existingConnection, contextOwnsConnection)
        {
        }

        public EmpresaDbContext(ObjectContext objectContext, bool dbContextOwnsObjectContext) : base(objectContext, dbContextOwnsObjectContext)
        {
        }

        public EmpresaDbContext(DbConnection existingConnection, DbCompiledModel model, bool contextOwnsConnection) : base(existingConnection, model, contextOwnsConnection)
        {
        }

        protected EmpresaDbContext(DbCompiledModel model) : base(model)
        {
        }
